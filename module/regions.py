...
regions = {
    ...
    ,"Semiárido Nordeste II": [
        "ADUSTINA, Bahia", "ANTAS, Bahia", "BANZAÊ, Bahia", "CÍCERO DANTAS, Bahia", "CIPÓ, Bahia",
        "CORONEL JOÃO SÁ, Bahia", "EUCLIDES DA CUNHA, Bahia", "FÁTIMA, Bahia", "HELIÓPOLIS, Bahia",
        "JEREMOABO, Bahia", "NOVA SOURE, Bahia", "NOVO TRIUNFO, Bahia", "PARIPIRANGA, Bahia",
        "PEDRO ALEXANDRE, Bahia", "RIBEIRA DO AMPARO, Bahia", "RIBEIRA DO POMBAL, Bahia",
        "SANTA BRÍGIDA, Bahia", "SÍTIO DO QUINTO, Bahia"
    ],    
    "Itaparica, Bahia": [
        "ABARÉ, Bahia", "CHORROCHÓ, Bahia", "GLÓRIA, Bahia", "MACURURÉ, Bahia",
        "PAULO AFONSO, Bahia", "RODELAS, Bahia"
    ]
}
